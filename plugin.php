...
if( ! class_exists('Updater') ) {
	...
	class Updater {
		...
		public static function init() {
			...
			load_plugin_textdomain('updater', false, "{$folder}/lang");
		}
		...
		public static function actionAdminMenu() {
			...
			add_submenu_page('__', 'Updater', __('Manual update', 'updater'), 'manage_options', 'updater-update', 'Updater::callbackUpdatePage');
		}
